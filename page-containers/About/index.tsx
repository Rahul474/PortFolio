  ...
  return (
    <section className='lg:h-screen min-h-screen relative pt-2 flex flex-col justify-center items-center text-center lg:flex-row lg:justify-around'>
      ...
      <motion.img
        ...
        src='https://res.cloudinary.com/da1qp92zl/image/upload/v1697263620/WhatsApp_Image_2023-10-13_at_11.05.59_PM_1_irkolm.jpg'
        alt='cover-pic'
      />
      <div className='p-4 text-left'>
        <ul>
          <li>
            Hello, I am Rahul Arora, a dedicated coder with a strong
            passion for crafting digital solutions. I am a proud graduate of the
            prestigious{' '}
            <strong>
            Guru Gobing Singh Indraprastha University(GGSIPU)
            </strong>
            , where I completed my studies in the year 2020.
          </li>
          <li>
          ...
          <li>
            ...
            <strong>NodeJS</strong> to build robust server-side solutions. This
          ...
          <li>
            ...
            programming languages like <strong>Javascript</strong> enabling me to tackle a wide range of
